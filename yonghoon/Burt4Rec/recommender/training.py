...
def train(
    data_csv_path: str = "/opt/ml/recsys/data/train/rating_1.csv",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_csv_path", default="D:/Workspace/Movie_Recommendation/data/train/rating_1.csv")
